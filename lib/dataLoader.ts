...
export function buildCountryLookup(countries: Country[]): Record<string, Country> {
  const isoToNumeric: Record<string, string> = {
    ...
    KZ: "398", UZ: "860", TM: "795", KG: "417", TW: "158", 
    QA: "634", CD: "180", PS: "275", TJ: "762", GE: "268", 
    AM: "051", AZ: "031", IQ: "368", SY: "760", JO: "400",
    LB: "422", LY: "434", TN: "788", DZ: "012", MA: "504",
    CU: "192", DO: "214", HT: "332", JM: "388", RS: "688",
    BA: "070", HR: "191", SI: "705", ME: "499", MK: "807",
    AL: "008", BG: "100", XK: "412",
  };
